...
import Portals from '@CoreComponents/Portals';
import { useLocation } from 'react-router-dom';
import {
    getAccessToken,
    getMainMenu,
    getUserData,
} from '@CoreServices/SessionService';
import { findCurrentMenu } from '@CoreHelpers/MenuHelper';
import PrivateRoute from './PrivateRoute';
import {
    setPageTitle,
    toggleSidebar,
} from '@Core/store/slices/core/themeConfig';
...
const DefaultLayout = ({ children }: PropsWithChildren) => {
    ...
    useEffect(() => {
        ...
        let pageTitle = themeConfig.systemName;

        if (mainMenu) {
            const currentMenu = findCurrentMenu(mainMenu, location.pathname);
            if (currentMenu) {
